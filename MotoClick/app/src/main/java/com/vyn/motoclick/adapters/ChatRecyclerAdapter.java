...
public class ChatRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private void configureOtherChatViewHolder(OtherChatViewHolder otherChatViewHolder, int position) {
        Chat chat = mChats.get(position);
        String nameSender = chat.senderName.toString();
    ...
    private static class OtherChatViewHolder extends RecyclerView.ViewHolder {
        private TextView textMessageSender, textNameSender;

        public OtherChatViewHolder(View itemView) {
            super(itemView);
            textMessageSender = (TextView) itemView.findViewById(R.id.textMessageSender);
            textNameSender = (TextView) itemView.findViewById(R.id.textNameSender);
        }
    }
}